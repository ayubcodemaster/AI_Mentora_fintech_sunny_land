...
namespace AIMentora
{
    ...
    public class GameManager : MonoBehaviour
    {
        ...
        [Header("Dairy Shop")]
        public Item[] DairyEntries;

        [Header("Meat Shop")]
        public Item[] MeatEntries;
        
        [Header("Time settings")]
        [Min(1.0f)]
        public float DayDurationInSeconds;
        public float StartingTime = 0.5f;  // 0.5 = noon (daytime)
        public bool FreezeTime = true;     // Set to true to stop day/night cycle
        ...
        private void Start()
        {
            ...
            // Initialize lighting to starting time if frozen
            if (FreezeTime && DayCycleHandler != null)
            {
